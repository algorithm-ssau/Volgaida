...
def fill_database(host, port, user, password, database_name):
    ...
    drink_comp = ["Медовый сироп, огурцы свежие, апельсин, лайм, мята, фреш лимона, бон аква, спрайт", "Молоко, мороженое, сироп в ассортименте, взбитые сливки", "Карамельный сироп,Апельсиновый сок,Эспрессо,Мята", "Сироп бабл гам,Фреш лимона,Спрайт,лайм", "Сироп арбуз,фреш лимона,спрайт,лайм", "апельсиновый сок"]
